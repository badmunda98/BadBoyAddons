...
async def _(event):
    ...
    animation_chars = [
        "`root@ll_BAD_MUNDA_ll:~#` ",
        "`root@ll_BAD_MUNDA_ll:~# ls`",
        "`root@ll_BAD_MUNDA_ll:~# ls\n\n  usr  ghost  codes  \n\nroot@ll_BAD_MUNDA_ll:~#`",
        "`root@ll_BAD_MUNDA_ll:~# ls\n\n  usr  ghost  codes  \n\nroot@ll_BAD_MUNDA_ll:~# # So Let's Hack it ...`",
        "`root@ll_BAD_MUNDA_ll:~# ls\n\n  usr  ghost  codes  \n\nroot@ll_BAD_MUNDA_ll:~# # So Let's Hack it ...\nroot@ll_BAD_MUNDA_ll:~# `",
        "`root@ll_BAD_MUNDA_ll:~# ls\n\n  usr  ghost  codes  \n\nroot@ll_BAD_MUNDA_ll:~# # So Let's Hack it ...\nroot@ll_BAD_MUNDA_ll:~# touch setup.py`",
        "`root@ll_BAD_MUNDA_ll:~# ls\n\n  usr  ghost  codes  \n\nroot@ll_BAD_MUNDA_ll:~# # So Let's Hack it ...\nroot@ll_BAD_MUNDA_ll:~# touch setup.py\n\nsetup.py deployed ...`",
        "`root@ll_BAD_MUNDA_ll:~# ls\n\n  usr  ghost  codes  \n\nroot@ll_BAD_MUNDA_ll:~# # So Let's Hack it ...\nroot@ll_BAD_MUNDA_ll:~# touch setup.py\n\nsetup.py deployed ...\nAuto CMD deployed ...`",
        "`root@ll_BAD_MUNDA_ll:~# ls\n\n  usr  ghost  codes  \n\nroot@ll_BAD_MUNDA_ll:~# # So Let's Hack it ...\nroot@ll_BAD_MUNDA_ll:~# touch setup.py\n\nsetup.py deployed ...\nAuto CMD deployed ...\n\nroot@ll_BAD_MUNDA_ll:~# trap whoami`",
        "`root@ll_BAD_MUNDA_ll:~# ls\n\n  usr  ghost  codes  \n\nroot@ll_BAD_MUNDA_ll:~# # So Let's Hack it ...\nroot@ll_BAD_MUNDA_ll:~# touch setup.py\n\nsetup.py deployed ...\nAuto CMD deployed ...\n\nroot@ll_BAD_MUNDA_ll:~# trap whoami\n\nwhoami=user`",
        "`root@ll_BAD_MUNDA_ll:~# ls\n\n  usr  ghost  codes  \n\nroot@ll_BAD_MUNDA_ll:~# # So Let's Hack it ...\nroot@ll_BAD_MUNDA_ll:~# touch setup.py\n\nsetup.py deployed ...\nAuto CMD deployed ...\n\nroot@ll_BAD_MUNDA_ll:~# trap whoami\n\nwhoami=user\nboost_trap on force ...`",

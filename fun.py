...
from . import BadBoy_cmd, get_string, HNDLR, async_searcher


@BadBoy_cmd(pattern="joke$")
async def _(ult):
    await ult.eor(get_joke())


@BadBoy_cmd(pattern="url ?(.*)")
async def _(event):
